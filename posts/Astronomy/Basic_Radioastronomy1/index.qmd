---
title: "Power, Intensity, Brightness and Radiation Energy Density"
author: "Young Jeong Lee"
date: "2026-07-24"
description: "전파 천문학에서 다루는 물리량인 Power, Intensity, Brightness, Radiation Energy Density에 대해서 소개하는 글이다."
categories: 
...
- 식 (1.2)는 **플럭스 밀도(flux density)** 라고 부르며, 단위로 $\text{W m}^{-2} \text{Hz}^{-1}$ 를 가진다. 
    - 책마다 **spectral flux density**, **spectral power flux density** 등으로 불린다. 
    - 만약 식 (1.2)가 주파수에 대해 적분된 복사량이면, 즉, 단위가 $\text{W m}^{-2}$ 라면, **power flux density**라고 불린다.  
