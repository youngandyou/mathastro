...
**(i)** $R$ is called a ***commutative ring*** if $\forall a, b \in R, ab = ba$.

**(ii)** $R$ is called a ***ring with identity*** if $\exists 1 \in R$ such that $\forall a \in R, a1 = a = 1a$.

**(iii)** $R$ is called a ***commutative ring with identity*** if $R$ is a commutative ring and a ring with identity.
