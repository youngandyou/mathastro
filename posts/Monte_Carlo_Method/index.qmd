...
author: "Youmin Chun"
date: "2026-08-05"
description: "강화 학습에서 model-free 문제를 푸는 방법 중 하나인 Monte Carlo method에 대해서 소개한다."
categories: 
...
한편, 우리는 여전히 dynamics function $p$를 모르므로 value function $v$을 가지고 직접 계산할 수는 없다. 때문에 action-value function $q$를 사용해 업데이트를 하게 된다.
$$Q(S_t, A_t) \longleftarrow Q(S_t, A_t) + \alpha_t \left[ G_t - Q(S_t, A_t) \right]$$
